...
void __fastcall CNavXML::ParseNode(_di_IXMLNode Node)
{
	...
	*/
	...
	if(nodetype==1)
	{
		...
		if(sTagName == "nav")			tag_nav(Node);
		else if(sTagName == "ol")   	tag_ol(Node);
		else if(sTagName == "li")   	tag_li(Node);
		else if(sTagName == "a")   		tag_a(Node);
		else if(sTagName == "cblink")	tag_cblink(Node);
		else if(sTagName == "navlink")	tag_navlink(Node);
		else tag_default(Node);
	}
	else if(nodetype==3)
	{
		// 文字節點
